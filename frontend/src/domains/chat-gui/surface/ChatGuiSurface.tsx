      ...
      <div className="chat-gui-debug-layout">
        ...
        <section className="chat-gui-debug-detail">
          ...
          <DebugCardsPanel
            ...
            clientCards={clientDebugCards}
            eventFilter={debugEventFilter}
            onEventFilterChange={setDebugEventFilter}
            errorsOnly={debugErrorsOnly}
            onErrorsOnlyChange={setDebugErrorsOnly}
