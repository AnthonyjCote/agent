        ...
        left={
          <div className="agent-chart-icon-actions">
            ...
            <IconButton
              ...
              ariaLabel="Toggle hierarchy edit mode"
              ariaPressed={hierarchyMode}
              active={hierarchyMode}
              icon={(
                <svg viewBox="0 0 20 20" aria-hidden="true">
